...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Ka(){return new Hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Dr(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Za(){return new Hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dr(),fragmentShader:`
...
#define LOW_PRECISION`),e}function _p(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Bo?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Bc?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===en&&(e="SHADOWMAP_TYPE_VSM"),e}function xp(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case hi:case di:e="ENVMAP_TYPE_CUBE";break;case ys:e="ENVMAP_TYPE_CUBE_UV";break}return e}function vp(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case di:e="ENVMAP_MODE_REFRACTION";break}return e}function Mp(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Go:e="ENVMAP_BLENDING_MULTIPLY";break;case sl:e="ENVMAP_BLENDING_MIX";break;case rl:e="ENVMAP_BLENDING_ADD";break}return e}function Sp(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function yp(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=_p(t),l=xp(t),u=vp(t),h=Mp(t),d=Sp(t),m=t.isWebGL2?"":up(t),g=hp(r),_=i.createProgram();let p,f,T=t.glslVersion?"#version "+t.glslVersion+`
